...
import { BannerType, BannerTypeEnum, ServerType } from "@/types";
...
const ServerCard = (props: ServerType) => {
  return (
    ...
    "
    >
      <div className="flex   flex-1 w-full bg-background overflow-hidden mask-b-from-50% mask-b-to-100%  rounded-t-[calc(var(--card-radius)-var(--card-padding))]  relative ">
        {/* badges on top */}
