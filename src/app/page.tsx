    ...
    const renderContent = () => {
            ...
            return (
                <>
                    ...
                    <p className="text-[#b5bac1] text-base mb-8 max-w-md">
                        We’re stoked to have you here. Jump into your
                        communities, catch up with friends, or start a fresh new
                        Tiff.
                    </p>
                    <Button
        ...
        return (
            <>
                ...
                <p className="text-[#b5bac1] text-base mb-8 max-w-md">
                    Connect with your friends and communities in real-time. Tiff
                    makes it easy to chat, share, and debate with the people who
                    matter most.
                </p>
                        ...
                        <div className="bg-[#2b2d31] rounded-xl overflow-hidden shadow-lg border border-[#3a3c41]">
                            <div className="aspect-video bg-[#1e1f22] flex items-center justify-center">
                                <span className="text-[#72767d] text-sm">
                                    This is where a cool image or animation
                                    could go.
                                </span>
                            </div>
                        </div>
