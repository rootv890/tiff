		...
		if (user) {
			return (
				<>
					...
					<Button className="bg-[#5865f2] hover:bg-[#4752c4] px-6 py-3 rounded-md font-medium text-sm transition-colors shadow-md">
						Go to Dashboard
					</Button>
				</>
			)
						...
						<div className="bg-[#2b2d31] rounded-xl overflow-hidden shadow-lg border border-[#3a3c41]">
							<div className="aspect-video bg-[#1e1f22] flex items-center justify-center">
								<span className="text-[#72767d] text-sm">
									This is where a cool image or animation could go.
								</span>
							</div>
						</div>
					</div>
